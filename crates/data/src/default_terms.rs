...
use mcrl3_aterm::{ATerm, ATermRef, Symbol};
...
impl DefaultSymbols {
    ...
    pub fn is_sort_expression(&self, term: &ATermRef<'_>) -> bool {
        term.symbol() == *self.sort_expression
    }
